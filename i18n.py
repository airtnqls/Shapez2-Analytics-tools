...
_ALIASES: Dict[str, str] = {
    ...
    "+ 새 탭": "ui.btn.new_tab",
    # Buildings buttons
    "절반 파괴기 (A)": "ui.btn.destroy_half",
    "스태커 (A가 아래)": "ui.btn.stack",
    "핀 푸셔 (A)": "ui.btn.push_pin",
    "물리 적용 (A)": "ui.btn.apply_physics",
    "스와퍼 (A, B)": "ui.btn.swap",
    "커터 (A)": "ui.btn.cutter",
    "90 회전": "ui.btn.rotate90",
    "180 회전": "ui.btn.rotate180",
    "270 회전": "ui.btn.rotate270",
    "심플 커터 (A)": "ui.btn.simple_cutter",
    "쿼드 커터 (A)": "ui.btn.quad_cutter",
    "페인터:": "ui.painter.label",
    "칠하기": "ui.btn.paint",
    "크리스탈 생성:": "ui.crystal.label",
    "생성": "ui.btn.generate",
    "분류기 (A)": "ui.btn.classifier",
    ...
    "스태커 (∀+B)": "ui.btn.stack_forall_plus_b",
    "스와퍼 (A↔B)": "ui.btn.swap_a_b",
    "스와퍼 (∀↔B)": "ui.btn.swap_forall_b",
    "출력 A": "ui.output.a",
    "출력 B": "ui.output.b",
    "출력 C": "ui.output.c",
    "출력 D": "ui.output.d",
